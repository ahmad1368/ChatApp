...
- #40 Community Guidelines acceptance — new first onboarding step, mandatory checkbox gate (no skip) recording an accepted-version number for future re-consent
