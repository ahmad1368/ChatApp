...
- #37 Verified badge — `GET /api/users/:userId/badge` (boolean-only, no image exposure) plus a reusable blue-checkmark `VerifiedBadge` component shown after selfie verification
