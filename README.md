...
- #38 Guest mode with limited access — an entry choice screen (sign up vs. continue as guest); guests can read the chat but sending is disabled client-side and rejected server-side
