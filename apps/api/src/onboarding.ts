 ...
 * mid-onboarding (lost connection, switched devices, browser crash) and
 * resume exactly where they left off instead of restarting from scratch.
 * See #39 for the client-side half of this: a stable draft id persisted
 * in localStorage so the client can find its way back to this record
 * without needing a bookmarked URL.
 */
