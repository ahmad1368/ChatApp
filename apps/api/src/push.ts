...
export class PushService {
   ...
   * author (e.g. Tinder's real "new Match" push, #151) — unlike
   * notifyOthers()'s broadcast to everyone else, this targets a single
   * person across however many devices they've subscribed from.
   */
